# Desafio Alura - App de Música
Projeto final do curso ["Java: Aplicando Orientação a Objetos"](https://cursos.alura.com.br/completeCourse/java-aplicando-orientacao-objetos), da Alura.

## 💻 O desafio
Implementar uma aplicação para cadastrar músicas e podcasts preferidos, modelando as classes utilizando Orientação a Objetos, em Java.
### 📝 Requisitos
...
- Os seguintes conceitos de Orientação a Objetos foram trabalhados:
  - Abstração
  - Herança
  - Encapsulamento
  - Polimorfismo
